...
function layout_loader_initialise(){
    ...
    module.nvs = [];
    module.maxevents = 0;
    module.evsperevent = 2;
    module.numevents = 0;
    module.numevents = 0;
    module.processor = 9;
    module.networkaddress = "2";
    module.events = [];
    layout.modules.push(module);
